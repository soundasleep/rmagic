...
RSpec.describe RemoveCardFromAllZones, type: :service do
  let(:service) { RemoveCardFromAllZones.new(duel: duel, player: player, card: card) }
  ...
  context "a card in the battlefield" do
    ...
    context "after calling the service" do
      ...
      context "the card" do
        it "is not in the battlefield" do
