...
RSpec.describe "Reach", type: :game do
  ...
  context "in attacking phase" do
    ...
    context "a flyer" do
      ...
      context "is declared an attacker" do
        before { declare_attackers [attacker] }

        context "if player 2 has a reach card" do
          before { create_card player2.battlefield, Library::SkyrakerGiant }
          ...
          context "the card" do
            ...
            it "has the reach tag" do
              expect(card.card.has_tag?("reach")).to be(true)
            end
          end
          ...
          context "after passing priority" do
            ...
            context "declaring it as a defender" do
              ...
              context "after passing priority" do
                ...
                it "player 1 has a creature in the graveyard" do
                  expect(player1.graveyard_creatures.length).to eq(1)
                end

                it "player 2 has no creatures in the graveyard" do
                  expect(player2.graveyard_creatures).to be_empty
                end
